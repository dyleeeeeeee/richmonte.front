                ...
                <div>
                  ...
                  <ul className="space-y-3 text-neutral-600">
                    <li className="flex items-start space-x-3">
                      ...
                      <span className="text-base md:text-lg font-medium">Swiss-Grade Security</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Real-time Intelligence</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Private API Access</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Encrypted Communications</span>
                    </li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-3 text-neutral-600">
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Private Aviation</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Exclusive Events</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Estate Management</span>
                    </li>
                    <li className="flex items-start space-x-3">
                      <span className="text-gold-600 text-lg mt-1 font-bold">•</span>
                      <span className="text-base md:text-lg font-medium">Maison Acquisitions</span>
                    </li>
                  </ul>
                </div>
              </div>
